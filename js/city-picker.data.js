...
var ul=document.querySelectorAll('.cite>ul')[0];
var letter= ['A','B','C','F','G','H','J','L','N','Q','S','T','X','Y','Z'];
	 //第一层循环letter.length
	
var str = '';
	for(var i=0;i<letter.length;i++){
		str +='<li>'+
			'<span id="city'+letter[i]+'">'+letter[i]+'</span>';
				for(var j=0;j<ChineseDistricts[86][letter[i]].length;j++){
					str +='<dl>';
					str +='<dt><a href="#">'+ChineseDistricts[86][letter[i]][j].address.slice(0,2)+'</a></dt>';
					var x=ChineseDistricts[ChineseDistricts[86][letter[i]][j].code]
						for(var atr in x){
							str+='<dd><a href="#">'+ChineseDistricts[ChineseDistricts[86][letter[i]][j].code][atr]+'</a></dd>';
						}
					str +='</dl>';
				}
		str +='</li> ';
